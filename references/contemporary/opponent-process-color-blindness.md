# The Opponent Process Model & Color Blindness

**Source:** [Color Nerd](https://www.youtube.com/@ColorNerd1) (YouTube Shorts)
**Date:** 2024-02-22
**URL:** https://www.youtube.com/watch?v=DO0kTNxEFrs
**Duration:** 1:26
**Views:** 2,448
...
> "Orange and blue is one of the most commonly used color schemes because it's actually accessible to BOTH red-green and yellow-blue color blindness."

Orange = on the B axis (yellowish) AND the A axis (reddish). Blue = opposite on the B axis. This pair maintains contrast regardless of which opponent axis is missing.
...
- Orange-blue works for both because it spans BOTH opponent axes
